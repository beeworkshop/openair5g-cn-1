    ...
    case NW_GTPV2C_ULP_API_INITIAL_REQ_IND:
      ...
      printf("UlpApi: NW_GTPV2C_ULP_API_TRIGGRED_RSP_IND\n");
        ...
        case NW_GTP_CREATE_BEARER_RSP:
		  printf("Ulp recv GTP msg: NW_GTP_CREATE_BEARERi_RSP\n");
...
static void *s11_sgw_thread (void *args)
{
  ...
  while (1) {
    ...
    case UDP_DATA_IND:{
         ...
         */
		printf("TASK_S11 recv: UDP_DATA_IND\n");
        nw_rc_t                                   rc;
