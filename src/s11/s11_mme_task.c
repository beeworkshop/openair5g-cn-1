  ...
  void *args)
{
  ...
  while (1) {
	...
	case S11_CREATE_SESSION_RESPONSE:
	  printf("TASK_S11 recv: S11_CREATE_SESSION_RESPONSE\n");
	  break;

    case S11_DELETE_SESSION_REQUEST:{
		printf("TASK_S11 recv: S11_DELETE_SESSION_REQUEST\n");
        s11_mme_delete_session_request (&s11_mme_stack_handle, &received_message_p->ittiMsg.s11_delete_session_request);
      }
      break;

    case S11_MODIFY_BEARER_REQUEST:{
		printf("TASK_S11 recv: S11_MODIFY_BEARER_REQUEST\n");
    ...
    case S11_RELEASE_ACCESS_BEARERS_REQUEST:{
		printf("TASK_S11 recv: S11_RELEASE_ACCESS_BEARERS_REQUEST\n");
